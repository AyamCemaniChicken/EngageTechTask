    ...
    private static async Task CommandExecutedAsync(Optional<CommandInfo> command, ICommandContext context, IResult result)
    {
        ...
        switch (result.Error)
        {
            ...
            case CommandError.Exception:
                await GenerateMessage.Error(context, title: $"Command exception: {result.ErrorReason}.", description: "If this message persists, please let us know in the support server!");
                break;
